...
export default function WatchNow(){
    return(
        <div className='homegrid flex  flex-col gap-5'>
            ...
            <Image src={home} className='' loading='lazy'  alt={'no'}/>
            ...
            <p className='text-primary-grey-text text-center line-clamp-2 md:line-clamp-5'>StreamVibe is the best streaming experience for watching your favorite movies and shows on demand, anytime, anywhere. With StreamVibe, you can enjoy a wide variety of content, including the latest blockbusters, classic movies, popular TV shows, and more. You can also create your own watchlists, so you can easily find the content you want to watch.</p>
