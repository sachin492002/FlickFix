...
export default function WatchNow(){
    return(
        <div className='flex flex-col items-center watchnow'>
            <svg xmlns="http://www.w3.org/2000/svg" width="300" height="300" viewBox="0 0 470 470" fill="none">
                <svg xmlns="http://www.w3.org/2000/svg" x="170" y="150" width="160" height="161" viewBox="0 0 160 161" fill="none">
                    <g filter="url(#filter0_b_90_252)">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                              ...
                              fill="url(#paint0_linear_90_252)" fill-opacity="0.3"/>
                        <path
                            ...
                            stroke="url(#paint1_linear_90_252)" stroke-opacity="0.5"/>
                    </g>
                    <defs>
                        <filter id="filter0_b_90_252" x="17.9376" y="13.8754" width="125.569" height="133.271"
                            ...
                            <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_90_252"
                                     result="shape"/>
                        </filter>
                ...
                <g filter="url(#filter0_b_90_251)">
                    <path
                        ...
                        fill="url(#paint0_linear_90_251)" fill-opacity="0.3"/>
                    <path
                        ...
                        stroke="url(#paint1_linear_90_251)" stroke-opacity="0.5"/>
                </g>
                <defs>
                    ...
                    <linearGradient id="paint0_linear_90_251" x1="235" y1="0" x2="235" y2="470"
                                    gradientUnits="userSpaceOnUse">
                        <stop stop-color="white" stop-opacity="0.5"/>
                        <stop offset="1" stop-color="white"/>
                    </linearGradient>
                    <linearGradient id="paint1_linear_90_251" x1="235" y1="0" x2="235" y2="470"
                                    gradientUnits="userSpaceOnUse">
                        <stop stop-color="white" stop-opacity="0"/>
                        <stop offset="1" stop-color="white"/>
                    </linearGradient>
