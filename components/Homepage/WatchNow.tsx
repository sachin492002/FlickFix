...
export default function WatchNow(){
    return(
        <div className='homegrid flex  flex-col gap-5'>
            ...
            <Image placeholder='empty'  src={home} className='hover:animate-spin ' loading='lazy'  alt={'no'}/>
            <div className='px-10 md:px-40 flex items-center flex-col gap-2 md:gap-6'>
            <h3 className=' text-xl md:text-4xl  text-center'>The Best Streaming Experience</h3>
            <h1 className='text-primary-grey-text text-center line-clamp-2 md:line-clamp-5'>StreamJet is the best streaming experience for watching your favorite movies and shows on demand, anytime, anywhere. With StreamJet, you can enjoy a wide variety of content, including the latest blockbusters, classic movies, popular TV shows, and more. You can also create your own watchlists, so you can easily find the content you want to watch.</h1>
