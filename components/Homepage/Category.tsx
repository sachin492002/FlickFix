...
export default function Category() {
  ...
  let settings = {
    customPaging: function (i: number) {
      return (
        <div className="bg-primary-grey-text w-4 dotclass h-1.5 rounded-lg"></div>
      );
    },
    appendDots: (dots: any) => (
      <div className="">
  ...
  return (
    <div
      className="flex flex-col items-center px-2 md:px-12 py-20 gap-16 mb-10 overflow-clip"
      id="category"
    >
      <div className="flex flex-row justify-between w-full gap-4">
        <div className="flex flex-col">
          ...
          <p className="text-primary-grey-text text-start">
            Whether you are looking for a comedy to make you laugh, a drama to
            make you think, or a documentary to learn something new
          </p>
        </div>
        <div className="swiper-nav-btns hidden md:inline-flex justify-between border-2 border-primary-grey gap-1 items-center text-2xl  rounded-lg bg-primary-black">
          <button
            aria-label="prev"
            className="p-4 bg-primary-grey rounded-lg"
            onClick={() => handlePrev()}
          >
            <FaArrowLeft />
          </button>
