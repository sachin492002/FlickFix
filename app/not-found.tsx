...
export default function NotFound() {
  return (
    ...
    <div className='notfound flex justify-between items-center p-10'>
        ...
        <h3 className='text-primary font-[horror] text-[200px] pb-40 font-extrabold '>4</h3>
        <img className='w-20 h-30' src='/homegrid/giri.png'/>
        <h3 className='text-primary font-[horror] text-[200px] pt-40 font-extrabold'>4</h3>
        </div>
        <h3 className='text-primary font-lobster' >Hair Not Found!</h3>
    </div>
    </>
  )
}
